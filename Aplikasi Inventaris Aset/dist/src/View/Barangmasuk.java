 ...
 * @author user
 */
public class Barangmasuk extends javax.swing.JDialog {
    ...
    public void lebarKolom() {
        TableColumn kolom;
        tblbm.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        kolom = tblbm.getColumnModel().getColumn(0);
        kolom.setPreferredWidth(40);
        kolom = tblbm.getColumnModel().getColumn(1);
        kolom.setPreferredWidth(50);
        kolom = tblbm.getColumnModel().getColumn(2);
        kolom.setPreferredWidth(100);
        kolom = tblbm.getColumnModel().getColumn(3);
        kolom.setPreferredWidth(100);
    }

    public void dataTable() {
        Object[] baris = {"No", "Tanggal", "Id barang Masuk", "Keterangan"};
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                String id_brgmasuk = hasil.getString("id_brgmasuk");
                String keterangan = hasil.getString("keterangan");
                String[] data = {"", tanggal, id_brgmasuk, keterangan};
                tm.addRow(data);
                noTable();
                lebarKolom();
            }
    ...
    public Barangmasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();
        lebarKolom();
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        String sql = "update tbl_brgmasuk set tanggal=?, id_brgmasuk=?, keterangan=? where id_brgmasuk='" + textid.getText() + "'";
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        if (textid.getText().equals("")) {
            JOptionPane.showConfirmDialog(null, "Kolom Id barang Masuk Barang Silahkan Diisi");
        } else if (textket.getText().equals("")) {
            JOptionPane.showConfirmDialog(null, "Kolom Keterangan Silahkan Diisi");
        } else {
            String sql = "insert into tbl_brgmasuk (tanggal,id_brgmasuk,keterangan) values (?,?,?)";
            String tampil = "yyyy-MM=dd";
            SimpleDateFormat fm = new SimpleDateFormat(tampil);
            String tanggal = String.valueOf(fm.format(tglbm.getDate()));
            try {
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from tbl_brgmasuk where id_brgmasuk='" + textid.getText() + "'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void tblbmMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbmMouseClicked
        int baris = tblbm.getSelectedRow();
        ...
        Date dateValue = null;
        try {
            dateValue = date.parse((String) tblbm.getValueAt(baris, 1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Barangmasuk dialog = new Barangmasuk(new javax.swing.JFrame(), true);
